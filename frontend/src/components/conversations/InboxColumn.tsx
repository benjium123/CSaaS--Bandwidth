...
import { LogOut, MessageSquare, Phone, Plus, Search, ShieldCheck } from "lucide-react";
...
function LineRow({
  ...
  return (
    <Button
      ...
      className="cx-row h-auto w-full items-center justify-start gap-3 rounded-[12px] px-2.5 py-[9px] text-left text-xs text-foreground"
    >
