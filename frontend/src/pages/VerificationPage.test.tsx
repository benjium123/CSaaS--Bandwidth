...
function fixture(verified = true) {
  return {
    ...
    use_case: { vertical: "Consulting", description: "Calling customers", destination_countries: ["NZ"] },
...
describe("Standalone personal verification", () => {
  ...
  it("requires agreement and sends the short form before submitting", async () => {
    ...
    expect(saved?.init.json).toMatchObject({ legal_name: "Ada Solo", country: "PK", phone: "+923001234567", industry: "Consulting", customer_country: "NZ" });
