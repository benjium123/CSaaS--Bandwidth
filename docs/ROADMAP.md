...
| 10 | P28 Messaging: MMS, send-later, link tracking, plain failure reasons (closes D43) | docs/PLAN_P26_P36.md | 0030 (schema committed) | backend committed (6d6d76c), not deployed; frontend drafting |
