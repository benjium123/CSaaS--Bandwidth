...
async def create_outbound_call(
    ...
    *,
    ...
    for _carrier, caller_id in attempts:  # failover dials from these numbers too
        await e911.require_e911(
            session, telephony_access._settings_of(session), org_id, caller_id, to
        )
